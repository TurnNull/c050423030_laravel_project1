                            ...
                            <tbody>
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->stock }}</td>
                                        <td>
                                            <a class="btn btn-warning" href="{{ route('products.show', $product->slug) }}">
                                                Show
                                            </a>
                                            <a href="{{ route('products.edit', $product->slug) }}" class="btn btn-secondary">
                                                Edit
                                            </a>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" 
                                            data-bs-target="#deleteModal{{ $product->slug }}">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
